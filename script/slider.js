...
window.addEventListener('load', onWndLoad('.slider1'), false);
window.addEventListener('load', onWndLoad('.slider2'), false);
window.addEventListener('load', onWndLoad('.slider3'), false);
window.addEventListener('load', onWndLoad('.slider4'), false);
window.addEventListener('load', onWndLoad('.slider5'), false);
window.addEventListener('load', onWndLoad('.slider6'), false);

function onWndLoad(sliderName) {
